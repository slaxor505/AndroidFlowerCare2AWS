 ...
 */
public class BluetoothLeJobService extends JobService
{

    private final static String TAG = BluetoothLeJobService.class.getSimpleName();
    ...
    private static final int STATE_WRITTING_BLE = 3;

    private static final int STATE_READING_BLE = 4;

    private static final int STATE_PUBLISHING_AWS = 5;

    private static final int STATE_INACTIVE = 99;
    ...
    public final static String UPDATE_TIMESTAMP =
            "com.example.bluetooth.le.UPDATE_TIMESTAMP";
    ...
    public static final String READ_PUBLISH_COMPLETE = "com.example.bluetooth.le.READ_PUBLISH_COMPLETE";
    ...
    private static JobParameters jobParam;
    private static boolean abortJobFlag;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback()
    {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState)
        {
            ...
            if (status!=0) {
                Log.i(TAG, "BLE error status: "+status);

                Log.i(TAG, "jobRun: "+newState+" Job finished with failure. Reschedule needed.");
                mConnectionState = STATE_INACTIVE;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status)
        {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS)
            {
                ...
                mConnectionState = STATE_READING_BLE;
                startMonitoring();

            }
            else
            {
                Log.w(TAG, "Discovery error. Status: " + status);
            }
        }
...
//                }
                ...
                mConnectionState=STATE_PUBLISHING_AWS;
                                 ...
                                 final BluetoothGattCharacteristic characteristic)
    {
        ...
        if (data != null && data.length > 0)
        {
            ...
            intent.putExtra(UPDATE_TIMESTAMP, currentTime);
        }
        sendBroadcast(intent);
    }
...
//    {
//        BluetoothLeJobService getService()
//        {
//            return BluetoothLeJobService.this;
//        }
//    }

    @Override
    public boolean onStartJob(final JobParameters param) {
        ...
        jobParam = param;
        Log.i(TAG, "jobRun: onStartJob: " + jobParam.getJobId());

        if (initialize()) {

            final PersistableBundle bundle = new PersistableBundle(jobParam.getExtras());
...
//                        .sendBroadcast(new Intent("ServiceMessage"));
    ...
    public boolean onStopJob(JobParameters params) {
        ...
        Log.i(TAG, "jobRun: onStopJob: "+jobParam.getJobId()+" Job forced to STOP.");
...
//    }
    ...
    private void startMonitoring()
    {
        if (mGattCharacteristics != null)
        {
            ...
            mConnectionState=STATE_WRITTING_BLE;
