...
public class DeviceScanActivity extends Activity
{
    ...
    private static TextView mPollInterval;

    //private final String myDeviceName = "sony-ble";
    private final String myDeviceName = "Flower care";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mPollInterval = (TextView) findViewById(R.id.pollInterval_view);

        mBLEFoundTextView.setText("Looking for "+myDeviceName+"...");
    ...
    private class LeDeviceListAdapter extends BaseAdapter
    {
        ...
        public void addDevice(BluetoothDevice device)
        {
            if (!mLeDevices.contains(device))
            {
                ...
                //adding only flowercare devices to mLeDevices
                if (device.getName().compareTo(myDeviceName) == 0) {
                    ...
                    Log.i(TAG, "===================================");
                    Log.i(TAG, "======>>>>> Adding device: '" + (device.getName() == null ? "Unknown" : device.getName())+"' Mac: "+device.getAddress());
                    Log.i(TAG, "===================================");


                    //mBLEFoundTextView.setText(myDeviceName + " found!");
                    //Log.i(TAG, "======>>>>> " + myDeviceName + " found!");
                    //scanLeDevice(false);
                    //connectToMyDevice();
                }
...
//
    public static int GetPollInterval() {
        ...
        return Integer.parseInt(mPollInterval.getText().toString());
