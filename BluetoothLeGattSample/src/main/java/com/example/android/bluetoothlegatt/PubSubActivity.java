...
//    Button btnDisconnect;
    ...
    public PubSubActivity(Context context) {
...
//                        });
    ...
    public void connect(final String msg) {
            ...
            Log.d(LOG_TAG, "Connecting clientId = " + clientId);
                ...
                mqttManager.connect(clientKeyStore, new AWSIotMqttClientStatusCallback() {
                    ...
                    public void onStatusChanged(final AWSIotMqttClientStatus status,
                        ...
                        if (status == AWSIotMqttClientStatus.Connected) {
                            ...
                            //publish
                            try {
                                Log.d(LOG_TAG, "Publishing: " + msg);
                                mqttManager.publishString(msg, AWSIOT_TOPIC, AWSIotMqttQos.QOS0);
                                //SLAX: job finished
                            } catch (Exception e) {
